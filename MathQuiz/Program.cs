...
namespace MathQuiz
{
    ...
    {
        // Method: Main
        // Purpose: solution to #2 (adding a timer to quiz)
        // Restrictions: None
        ...
        start:
            ...
            {
                //time bool is true bc new question
                bTimeOut = false;
                ...
                //5 sec timer for each question; marked wrong once 5 sec is up
                ...
                do
                {
                    ...
                    //shows question and reads input
                    ...
                    //will break loop once time is up and user presses return
                    if (bTimeOut)
                    {
                        break;
                    }
        ...
        //once 5 sec is up, it will notify the user
        static void TimesUp(object source, ElapsedEventArgs e)
        {
            //tells user to return to get next question
            Console.WriteLine();
            Console.WriteLine("Your time is up! Press return to see the next question");
